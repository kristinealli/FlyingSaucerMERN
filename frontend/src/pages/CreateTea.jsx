...
import teaBKG from '../assets/images/fsaddtea.jpg';
...
const CreateTea = () => {
    ...
    return (
        <div><BackButton />
            <div className="min-h-screen font-serif bg-space flex flex-col items-center pt-10 pb-20 px-20 bg-cover" style ={{backgroundImage: `url(${teaBKG})`}}>

                <div className="w-full max-w-md bg-black/50 backdrop-blur-sm rounded-lg p-4"> {/* Overlay div with mask effect */}

                    {loading ? (
                        <Spinner />
                    ) : (
                        <div className="w-full max-w-md">
                            <h1 className="text-stardust text-5xl font-bold text-center mb-5 mt-5">
                                Add a New Tea
                            </h1>
                            <form onSubmit={handleSaveTea} className="shadow-md rounded px-8 pt-6 pb-8 mb-4">
                                <div className="mb-4">
                                ...
                                <div className="mb-6 flex items-start gap-2 justify-start">
